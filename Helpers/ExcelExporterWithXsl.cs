...
namespace YTUsageViewer.Helpers
{
  public class ExcelExporterWithXsl : IExcelExporter
  {
    ...
    public Byte[] ExportDataAsSpreadsheet<T>(IEnumerable<T> enumerableData)
    {
      ...
      return Transform2SpreadsheetMLUsingXSL(xmlReader).ToArray();
    }
    ...
    private MemoryStream Transform2SpreadsheetMLUsingXSL(XmlReader reader)
    {
    ...
    private MemoryStream GetStreamFromString(string input)
    {
